<!DOCTYPE html>
<?php  header("Location: http://localhost/OCR/app/index.php"); ?>
<html lang="en">
    <head>
        <meta charset="utf-8" />
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto my-2 my-lg-0">
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#about">translator</a></li>
            ...
            <div class="container-fluid p-0">
                <div class="row no-gutters">
                    ...
                    <div class="col-lg-4 mr-auto text-center">
                        ...
                        <a class="d-block" href="mailto:contact@yourwebsite.com">ithelpdesk24@googlemail.com</a>
                    </div>
                </div>
            </div>
        </section>
